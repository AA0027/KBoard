...
-- 샘플 authority
INSERT INTO t5_authority (name) VALUES ('ROLE_MEMBER'), ('ROLE_ADMIN');

-- 샘플 user
INSERT INTO t5_user (username, password, name, email) VALUES
('USER1', '$2a$10$X1TE7QH60brSgDFrKmVhc.aacsLYGkqECofec0JLgAEKp2INg6R7a', '회원1', 'user1@mail.com'),
('USER2', '$2a$10$EkBofHEotczGzjR1wxPhle5Aax09GDZAwLRo5G3P6Xi/oQpgv1Gda', '회원2', 'user2@mail.com'),
('ADMIN1', '$2a$10$Z3vvvfUfvXQ6a9Qkfc4s2u46JVlDIN9sABMpXmngX/GmK.zobAxkS', '관리자1', 'admin1@mail.com')
;
