...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/board/detail/**").authenticated()
                        .requestMatchers("/board/write/**", "/board/update/**", "board/delete/**")
                        // ↓ "/board/write/**", "/board/update/**", "/board/delete/**" URL 로
                        // 들어오는 요청은 '인증' 뿐 아니라 ROLE_MEMBER 나 ROLE_ADMIN 권한을 갖고 있어야 한다. ('인가')
...
//                      .passwordParameter("bbb") // 기본 name="password"
                ...
                .logout(conf -> conf.logoutUrl("/user/logout")
                ...
                .oauth2Login(httpSecurityOAuth2LoginConfigurer -> httpSecurityOAuth2LoginConfigurer
                        ...
                        .userInfoEndpoint(userInfoEndpointConfig -> userInfoEndpointConfig
                                ...
                                .userService(principalOauth2UserService))  // userService(OAuthUserService)
